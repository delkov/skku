...
:radio_row{label=""; 
:radio_button{label="ON"; key="on_contour"; value="1";}
:radio_button{label="OFF"; key="off_contour"; value="0";}
} 

:edit_box{label="Начальный уровень       "; key="start_level"; value="60"; edit_width="8";}
